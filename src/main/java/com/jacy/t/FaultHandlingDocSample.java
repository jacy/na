...
import static com.jacy.t.FaultHandlingDocSample.CounterServiceApi.GetCurrentCount;
import static com.jacy.t.FaultHandlingDocSample.WorkerApi.Do;
import static com.jacy.t.FaultHandlingDocSample.WorkerApi.Start;
...
import com.jacy.t.FaultHandlingDocSample.CounterApi.UseStorage;
import com.jacy.t.FaultHandlingDocSample.CounterServiceApi.CurrentCount;
import com.jacy.t.FaultHandlingDocSample.CounterServiceApi.Increment;
import com.jacy.t.FaultHandlingDocSample.CounterServiceApi.ServiceUnavailable;
import com.jacy.t.FaultHandlingDocSample.StorageApi.Entry;
import com.jacy.t.FaultHandlingDocSample.StorageApi.Get;
import com.jacy.t.FaultHandlingDocSample.StorageApi.StorageException;
import com.jacy.t.FaultHandlingDocSample.StorageApi.Store;
import com.jacy.t.FaultHandlingDocSample.WorkerApi.Progress;
...
public class FaultHandlingDocSample {
	...
	public static class Worker extends UntypedActor {
		...
		public void onReceive(Object msg) {
			...
			if (msg.equals(Start) && progressListener == null) {
				...
				getContext().system().scheduler().schedule(Duration.Zero(), Duration.create(1, "second"), getSelf(), Do, getContext().dispatcher(), getSelf());
				...
				pipe(ask(counterService, GetCurrentCount, askTimeout).mapTo(classTag(CurrentCount.class)).map(new Mapper<CurrentCount, Progress>() {
	...
	public interface CounterServiceApi {
		...
		public static class ServiceUnavailable extends RuntimeException {
			private static final long serialVersionUID = 5416147131865046576L;
	...
	public static class CounterService extends UntypedActor {
		...
		public void onReceive(Object msg) {
			...
			if (msg instanceof Entry && ((Entry) msg).key.equals(key) && counter == null) {
				...
				getContext().system().scheduler().scheduleOnce(Duration.create(10, "seconds"), getSelf(), Reconnect, getContext().dispatcher(), getSelf());
	...
	public interface StorageApi {
		...
		public static class StorageException extends RuntimeException {
			private static final long serialVersionUID = 5514173660658134375L;
