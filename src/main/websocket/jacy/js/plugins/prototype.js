(function($) {
  ...
  $.pp = {
    ...
    cmd_unwatch:  generate_cmd("UNWATCH", 
      [4, {type: "integer", prop: "gid"}]),
    cmd_leave:  generate_cmd("LEAVE", 
      [9, {type: "integer", prop: "gid"}, {type: "integer", prop: "pid"}]),
    cmd_fold:  generate_cmd("FOLD", 
      [7, {type: "integer", prop: "gid"}]),
    cmd_raise:  generate_cmd("RAISE", 
    ...
    notify_seat_state: generate_notify("SEAT_STATE", [30,
      ...
      {type: "decimal", prop: "inplay"},
      {type: "string",  prop: "nick", base64: false}]),
    notify_seat_detail: generate_notify("SEAT_DETAIL", [83,
      {type: "integer", prop: "gid"},
      {type: "byte",    prop: "sn"},
      {type: "integer", prop: "state"},
      {type: "integer", prop: "pid"},
    ...
    notify_end: generate_notify("END", [24,
      {type: "integer", prop: "gid"}
    ]),
    notify_start: generate_notify("START", [23,
      {type: "integer", prop: "gid"}
    ]),
    notify_cancel: generate_notify("CANCEL", [25,
      {type: "integer", prop: "gid"}
    ]),
    ...
    notify_share: generate_notify("SHARE", [22,
      {type: "integer", prop: "gid"},
      {type: "byte", prop: "face"},
      {type: "byte", prop: "suit"}
    ]),
    notify_draw: generate_notify("DRAW", [21,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "byte", prop: "face"},
      {type: "byte", prop: "suit"}
    ]),
    notify_dealer: generate_notify("DEALER", [35,
      {type: "integer", prop: "gid"},
      {type: "byte", prop: "seat"}
    ]),
    notify_sblind: generate_notify("SBLIND", [36,
      {type: "integer", prop: "gid"},
      {type: "byte", prop: "seat"}
    ]),
    notify_bblind: generate_notify("BBLIND", [37,
      {type: "integer", prop: "gid"},
      {type: "byte", prop: "seat"}
    ]),
    notify_bet_req: generate_notify("BET_REQ", [20,
      {type: "integer", prop: "gid"},
      {type: "decimal", prop: "call"},
      {type: "decimal", prop: "min"},
      {type: "decimal", prop: "max"}
    ]),
    notify_actor: generate_notify("ACTOR", [84,
      {type: "integer", prop: "gid"},
      {type: "byte", prop: "seat"}
    ]),
    notify_raise: generate_notify("RAISE", [42,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "decimal", prop: "raise"},
      {type: "decimal", prop: "call"},
      {type: "integer", prop: "allin"}
    ]),
    notify_blind: generate_notify("BLIND", [85,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "decimal", prop: "blind"}
    ]),
    notify_unwatch: generate_notify("UNWATCH", [86,
      {type: "integer", prop: "gid"}
    ]),
    notify_show: generate_notify("SHOW", [40,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "byte", prop: "size"},
    ...
    notify_hand: generate_notify("HAND", [27,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "byte", prop: "rank"},
    ...
    notify_win: generate_notify("WIN", [26,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "decimal", prop: "amount"},
      {type: "decimal", prop: "cost"},
      {type: "integer", prop: "potid"}
    ]),
    notify_leave: generate_notify("LEAVE", [45,
	     {type: "integer", prop: "gid"},
	     {type: "integer", prop: "pid"}
     ]),
    notify_pot:generate_notify("POT", [201,
      {type: "integer", prop: "id"},
      {type: "decimal", prop: "amount"}
    ]),
    notify_join: generate_notify("JOIN", [44,
      {type: "integer", prop: "gid"},
      {type: "integer", prop: "pid"},
      {type: "byte",    prop: "sn"},
      {type: "decimal", prop: "inplay"},
